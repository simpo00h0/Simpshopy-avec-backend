...
export default function LandingPage() {
  return (
    <Box>
      ...
      {/* Footer - style Shopify */}
      <Box py="xl" px="xl" style={{ borderTop: '1px solid var(--mantine-color-gray-2)' }}>
        <Container size="lg">
          <SimpleGrid cols={{ base: 1, sm: 4 }} spacing="xl" mb="xl">
            <Stack gap="xs">
              <Text size="sm" fw={600}>Simpshopy</Text>
            ...
            <Stack gap="xs">
              <Text size="sm" fw={600}>Légal</Text>
